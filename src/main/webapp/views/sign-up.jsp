...
<!-- Mirrored from pixner.net/boleto/demo/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 12:43:57 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="account-area">
                    ...
                    <form class="account-form" action="register" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="comfirm_password" type="password" placeholder="Password" id="pass2" required>
                        </div>
